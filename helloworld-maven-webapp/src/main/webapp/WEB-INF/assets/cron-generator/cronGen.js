(function ($) {
    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            $('<li/>', { 'class': 'active' }).html($('<a id="HourlyTab" href="#Hourly">小时</a>')).appendTo(topMenu);
            ...
            var hourlyTab = $("<div/>", { "class": "tab-pane active", id: "Hourly" });
            ...
            $(yearly2).append("周期从");
            $("<input/>",{type : "text", id : "yearStart_0", value : "2016", style:"width:50px; height:20px;"}).appendTo(yearly2);
            $(yearly2).append("-");
            $("<input/>",{type : "text", id : "yearEnd_0", value : "2017", style:"width:50px; height:20px;"}).appendTo(yearly2);
            $(yearly2).append("年");
            ...
            // Add an input
            var $i = $("<input>", { type: 'text', readonly : true, placeholder: 'cron表达式...'}).addClass("form-control").val($(that).val());
            $i.appendTo($g);
            // Add the button
...
(function($) {
    ...
    $.fn.cronGen.tools = {
        ...
        cronResult : function() {
            ...
            if(year!="")
            {
                result = 0+" "+0+" "+hour+" "+day+" "+month+" "+week+" "+year;
            }else
            {
                result = 0+" "+0+" "+hour+" "+day+" "+month+" "+week;
            }
            return result;
        },
